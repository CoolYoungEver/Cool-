...
@implementation CoolMenuThirdTableViewCell

- (instancetype)initWithTableView:(UITableView *)tableView {
    static NSString *identifier = @"thirdCell";
    CoolMenuThirdTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"CoolMenuThirdTableViewCell" owner:nil options:nil] firstObject];
    }
    return cell;
}
