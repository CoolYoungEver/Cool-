...
@interface CoolMoreHViewController () <UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 2) {
        ...
        cell.model = model;
        cell.labtitle.text = [NSString stringWithFormat:@"%d、%@",indexPath.row + 1,model.stepState];
        NSLog(@"%@",model.stepState);
        return cell;
